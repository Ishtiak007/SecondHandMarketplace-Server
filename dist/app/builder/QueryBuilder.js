...
class QueryBuilder {
        ...
        $or: searchableFields.map((field) => {
          ...
          return {
            [field]: {
              $regex:
                (_a =
                  this === null || this === void 0 ? void 0 : this.query) ===
                  null || _a === void 0
                  ? void 0
                  : _a.search,
              $options: 'i',
  ...
  filter() {
    ...
    excludeFields === null || excludeFields === void 0
      ? void 0
  ...
  sortBy() {
    ...
    const sort =
      ((_c =
        (_b =
          (_a = this === null || this === void 0 ? void 0 : this.query) ===
            null || _a === void 0
            ? void 0
            : _a.sortBy) === null || _b === void 0
          ? void 0
  ...
  paginate() {
    ...
    const limit =
      Number(
        (_b = this === null || this === void 0 ? void 0 : this.query) ===
          null || _b === void 0
          ? void 0
          : _b.limit,
      ) || 10;
